    ...
    <Card className="relative flex items-start overflow-hidden p-0">
      ...
      <div className="h-full flex-1 overflow-hidden px-2 py-3">
        ...
        <div className="mt-3 flex flex-col gap-sm">
          <Tag
            className="bg-dark-4 hover:bg-dark-5 flex w-full items-center justify-between border-0"
            color="white"
          >
          ...
          <Tag
            className="bg-dark-4 hover:bg-dark-5 flex items-center justify-between border-0"
            color="white"
          >
            <Text size="xs" className="text-light-grey-3">
              Chap 2.3 EN
